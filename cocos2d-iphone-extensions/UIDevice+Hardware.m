...
-(BOOL)isHighPerfDevice
{
    if(UIDevice1GiPhone != [[UIDevice currentDevice] platformType] &&
       UIDevice3GiPhone != [[UIDevice currentDevice] platformType] &&
       UIDevice1GiPod   != [[UIDevice currentDevice] platformType] &&
       UIDevice2GiPod   != [[UIDevice currentDevice] platformType] &&
       UIDevice1GiPad   != [[UIDevice currentDevice] platformType])
    {
        return YES;
    }
    return NO;
...
-(BOOL)isHighMemDevice
{
    if(UIDevice1GiPhone != [[UIDevice currentDevice] platformType] &&
       UIDevice3GiPhone != [[UIDevice currentDevice] platformType] &&
       UIDevice1GiPod   != [[UIDevice currentDevice] platformType] &&
       UIDevice2GiPod   != [[UIDevice currentDevice] platformType] &&
       UIDevice3GiPod   != [[UIDevice currentDevice] platformType] &&
       UIDevice4GiPod   != [[UIDevice currentDevice] platformType] &&
       UIDevice1GiPad   != [[UIDevice currentDevice] platformType])
    {
        return YES;
    }
